...
This module wraps automatic pagination (with per-page retries)
and returns a full list to callers.
"""
...
def _fetch_page_with_retry(
    ...
    **kwargs: Any,
    ...
    """Single-page request with exponential backoff. Retries only transient network/IO errors."""
    if max_retries < 1:
...
def fetch_all_nodes(
    ...
    """Fetch graph nodes with pagination. Returns up to max_items (default 2000)."""
    all_nodes: list[Any] = []
