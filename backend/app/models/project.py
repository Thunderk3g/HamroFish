...
Used to persist project state on the server and avoid passing large data between APIs.
"""
...
class ProjectManager:
    """Project manager for persistence and lookup."""
    ...
    def list_projects(cls, limit: int = 50) -> List[Project]:
        ...
        Returns:
            Project list sorted by creation time (desc)
        """
        cls._ensure_projects_dir()
