    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          <!-- Graph visualization (show when data is available) -->
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Once generation completes, graph build will start automatically</p>
          </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After documents are uploaded, the LLM analyzes the content and automatically generates an ontology for opinion simulation (entity types + relation types).
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">Endpoint Description</div>
                <div class="detail-content">
                  Based on the generated ontology, chunk the documents and call the Zep API to build the knowledge graph, extracting entities and relations.
                </div>
              </div>
...
const loadProject = async () => {
  try {
    ...
    if (response.success) {
      ...
      // Continue polling the running task
...
const startBuildGraph = async () => {
  try {
    ...
    if (response.success) {
      ...
      // Start graph data polling (independent of task polling)
      startGraphPolling()
...
const renderGraph = () => {
  ...
  // Draw edges (with transparent click targets)
  ...
  // Click blank space to close detail panel
  svg.on('click', () => {
    closeDetailPanel()
  })
