  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">A concise, general-purpose collective intelligence engine</span>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            The prediction engine is standing by. Upload multiple unstructured files to initialize the simulation sequence.
          </p>
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Typical simulations average $5/run</div>
            </div>
            <div class="metric-card">
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Talk with any agent in the simulated world & talk with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Use natural language to describe simulation or prediction needs (e.g., If a university withdraws a disciplinary notice, how might public opinion evolve?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation - jump immediately; Process handles the API call
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Jump to Process (use special ID to indicate a new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Use Space Grotesk for headings, JetBrains Mono for code/labels
...
.console-box {
  ...
  padding: 8px; /* Inner padding for a double-border feel */
}
