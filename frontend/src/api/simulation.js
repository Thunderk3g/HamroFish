...
/**
 * Get agent profiles in realtime while generating
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Get simulation config in realtime while generating
 * @param {string} simulationId
 * @returns {Promise} Returns config info with metadata and content
 */
...
/**
 * Get simulation run status (realtime)
 * @param {string} simulationId
 */
...
/**
 * Get simulation run status details (includes recent actions)
 * @param {string} simulationId
 */
 ...
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 * @param {number} limit - result count
